...
const EmptyState = () => {
 ...
 const examplePrompts: ExampleImage[] = [
  ...
  { image: '/examples/111.png', prompt: 'A winning touchdown, fast shutter speed, movement tracking', width: 800, height: 800 },
  { image: '/examples/333.png', prompt: 'Aerial shot of a river flowing up a mystical valley', width: 800, height: 800 },
